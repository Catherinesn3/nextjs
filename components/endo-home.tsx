...
* @see https://v0.dev/t/xO1D60W4qfA
      ...
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex items-center justify-center">
                <img src="/placeholder.svg" width={400} height={400} alt="Exercise" className="rounded-xl" />
              </div>
            </div>
          </div>
        </section>
        <section id="meals" className="py-12 md:py-20 bg-muted">
          <div className="container px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex items-center justify-center">
                <img src="/placeholder.svg" width={400} height={400} alt="Meal Plans" className="rounded-xl" />
              </div>
              <div>
        ...
        <section id="infertility" className="py-12 md:py-20">
          <div className="container px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="flex items-center justify-center">
                <img src="/placeholder.svg" width={400} height={400} alt="Infertility" className="rounded-xl" />
              </div>
            </div>
          </div>
        </section>
        <section id="mental-health" className="py-12 md:py-20 bg-muted">
          <div className="container px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex items-center justify-center">
                <img src="/placeholder.svg" width={400} height={400} alt="Mental Health" className="rounded-xl" />
              </div>
              <div>
